...
import { 
  BrainCircuit, User, Mail, Lock, Loader2, ArrowRight, 
    ...
    if (googleClientId && window.google) {
      try {
        ...
        window.google.accounts.id.renderButton(
          ...
          { theme: "outline", size: "large", text: "signup_with", width: 384 }
        );
      } catch (err) {
      ...
      <div className="w-full max-w-md animate-fade-in z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-2">
            Start predicting churn risk with explainable AI
          </p>
        </div>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-2xl max-w-md w-full p-6 space-y-6 animate-fade-in">
            <div className="flex items-center gap-3">
              ...
              <h3 className="font-extrabold text-lg">Google Sign-Up Options</h3>
            </div>
